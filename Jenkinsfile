node {
  ...
  stage('Build Docker image') {
    ...
    stage('connection') {   
		    ...
		    sh 'ssh ubuntu@ec2-3-86-104-43.compute-1.amazonaws.com sudo docker kill sanyam-currentBuild.previousBuild.number'
			sh 'ssh ubuntu@ec2-3-86-104-43.compute-1.amazonaws.com sudo docker rm sanyam-currentBuild.previousBuild.number'
